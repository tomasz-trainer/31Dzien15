...
namespace helloworld
{
    class Program
    {
        public static async Task SynthesisToSpeakerAsync()
        {
            ...
            var config = SpeechConfig.FromEndpoint(new Uri(Environment.GetEnvironmentVariable("SPEECH_SERVICE_ENDPOINT")), Environment.GetEnvironmentVariable("SPEECH_SERVICE_KEY"));
